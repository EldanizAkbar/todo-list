/*! For license information please see main.a1808313.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, n, t) {
        ...
        function Bn(e) {
          ...
          for (; 0 < Mn.length && null === (t = Mn[0]).blockedOn; )
            jn(t), null === t.blockedOn && Mn.shift();
        }
            ...
            if (null === l) Hr(e, n, r, Yn, t), Fn(e, r);
              ...
              (function (e, n, t, r, l) {
                switch (n) {
                  ...
                  case "pointerover":
                    var a = l.pointerId;
                    return On.set(a, Dn(On.get(a) || null, e, n, t, r, l)), !0;
                  case "gotpointercapture":
                    return (
                      (a = l.pointerId),
        ...
        var Va = {
          ...
          enqueueSetState: function (e, n, t) {
            ...
            (a.payload = n),
              ...
              null !== (n = Ma(e, a, l)) && (ts(n, e, l, r), Ia(n, e, l));
          },
          ...
          enqueueForceUpdate: function (e, n) {
            ...
            (l.tag = 2),
              ...
              null !== (n = Ma(e, l, r)) && (ts(n, e, r, t), Ia(n, e, r));
          },
        };
        ...
        function Zo(e, n, t) {
          return 0 === (21 & mo)
            ? (e.baseState && ((e.baseState = !1), (wu = !0)),
              (e.memoizedState = t))
            : (ur(t, n) ||
                ((t = vn()), (ho.lanes |= t), (Fi |= t), (e.baseState = !0)),
              n);
        }
        function Jo(e, n) {
          var t = wn;
        ...
        function Nu(e, n, t, r, l) {
          ...
          if ((Ea(n, l), null === n.stateNode))
            Bu(e, n), Ba(n, t, r), Wa(n, t, r, l), (r = !0);
          else if (null === e) {
            var o = n.stateNode,
              u = n.memoizedProps;
            o.props = u;
        ...
        function ls(e, n) {
          ...
          if (0 !== n) {
            if (
              ...
              throw ((t = Ii), ds(e, 0), us(e, r), rs(e, Ge()), t);
            if (6 === n) us(e, r);
            else {
              if (
              ...
              switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = rl(ks.bind(null, e, Ai, Bi), n);
                    break;
                  }
                  ks(e, Ai, Bi);
                  break;
                case 4:
                  ...
                  if (
                    ...
                    e.timeoutHandle = rl(ks.bind(null, e, Ai, Bi), r);
                    break;
                  }
                  ks(e, Ai, Bi);
                  break;
        ...
        function is(e) {
          ...
          if (1 === t) throw ((t = Ii), ds(e, 0), us(e, n), rs(e, Ge()), t);
        ...
        function cs(e) {
          ...
          var t = Pi.transition,
            r = wn;
          try {
            if (((Pi.transition = null), (wn = 1), e)) return e();
          } finally {
            (wn = r), (Pi.transition = t), 0 === (6 & (Ni = n)) && $l();
          }
        }
        function fs() {
          (Oi = Ri.current), _l(Ri);
        ...
        function vs(e, n) {
          ...
          if ((ka(), (Ni = t), (_i.current = r), null !== Ti))
            throw Error(a(261));
        ...
        function Ss() {
          if (null !== Ki) {
            var e = kn(Yi),
              ...
              t = wn;
            try {
              if (((Pi.transition = null), (wn = 16 > e ? 16 : e), null === Ki))
                var r = !1;
              else {
        ...
        function Hs(e, n, t, r) {
          ...
          return (
            ...
            null !== (e = Ma(l, n, o)) && (ts(e, l, o, a), Ia(e, l, o)),
            o
          );
        }
        function Ws(e) {
  ...
  !(function () {
    ...
    var d = {
      ...
      p = e.createContext && e.createContext(d),
      m = function () {
        return (
          (m =
            Object.assign ||
    ...
    function v(n) {
      return (
        n &&
        n.map(function (n, t) {
          return e.createElement(n.tag, m({ key: t }, n.attr), v(n.child));
        })
      );
    }
    function g(n) {
      return function (t) {
        return e.createElement(y, m({ attr: m({}, n.attr) }, t), v(n.child));
      };
    }
    function y(n) {
      var t = function (t) {
        ...
        return (
          ...
          e.createElement(
            ...
            m(
              ...
              {
                className: r,
                style: m(m({ color: n.color || t.color }, t.style), n.style),
                height: i,
                width: i,
      ...
      return void 0 !== p
        ? e.createElement(p.Consumer, null, function (e) {
            return t(e);
          })
        : t(d);
    }
      ...
      k = (function (e) {
        ...
        function s(e) {
          ...
          return (
            ...
            ((n = a.call(this, e)).state = { newItem: "", list: [] }),
            n
          );
        }
        return (
          ...
          (t = [
            ...
            },
            {
              key: "addItem",
              value: function () {
                if ("" === this.state.newItem) alert("Input can't be empty");
                else {
                  var e = {
                      id: 1 + Math.random(),
                    ...
                    n = l(this.state.list);
                  n.push(e), this.setState({ list: n, newItem: "" });
                }
              },
            },
            {
              key: "deleteItem",
              value: function (e) {
                var n = l(this.state.list).filter(function (n) {
                  return n.id !== e;
                });
                ...
                return (0, w.jsxs)("div", {
                  children: [
                    ...
                    (0, w.jsx)("div", {
                      ...
                      children: (0, w.jsx)("div", {
                        class: "col-12 col-sm-8 col-lg-5 mx-auto",
                        children: (0, w.jsxs)("form", {
                          ...
                          children: [
                            (0, w.jsx)("input", {
                              ...
                              onChange: function (n) {
                                return e.updateInput("newItem", n.target.value);
                              },
                    ...
                    (0, w.jsx)("div", {
                      ...
                      children: (0, w.jsx)("div", {
                        className: "col-12 col-sm-8 col-lg-5 mx-auto",
                        children: (0, w.jsx)("ul", {
                          class: "list-group",
                          children: this.state.list.map(function (n) {
                            return (0, w.jsxs)(
                              "li",
                              {
                                class: "list-group-item mt-3 mb-2",
                                children: [
                                  n.value,
                                  (0, w.jsx)(b, {
                                    className: "todo-item",
                                    onClick: function () {
                                      return e.deleteItem(n.id);
                                    },
                                  }),
                                ],
                              },
    ...
    var S = function () {
      return (0, w.jsx)("div", {
        className: "container todo-app pb-5 mb-5",
        children: (0, w.jsx)(k, {}),
      });
    };
    n.render(
      (0, w.jsx)(e.StrictMode, { children: (0, w.jsx)(S, {}) }),
      document.getElementById("root")
    );
  })();
})();
//# sourceMappingURL=main.a1808313.js.map
